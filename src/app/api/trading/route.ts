...
async function fetchTradingData(requestId: string): Promise<TradingData> {
  ...
  const data: TradingData = {
    ...
    zarUsdChange24h:
      typeof parsed.zarUsdChange24h === "number" ? parsed.zarUsdChange24h : 0,
    ...
    jseAlsiChange:
      typeof parsed.jseAlsiChange === "number" ? parsed.jseAlsiChange : 0,
