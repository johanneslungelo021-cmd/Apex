...
const AI_TIMEOUT_MS =
  Number.isFinite(rawAiTimeout) && rawAiTimeout > 0 ? rawAiTimeout : 10000;
...
export async function POST(req: Request): Promise<Response> {
  try {
    ...
    if (!body || typeof body !== "object") {
      return NextResponse.json(
        {
          reply: "Request body must be a JSON object.",
    ...
    return NextResponse.json({
      reply:
        "I'm the Apex AI Assistant. I can help you with questions about our platform, digital income strategies, and more. Please configure AI_GATEWAY_API_KEY or GROQ_API_KEY for enhanced responses.",
    });
  } catch (error: unknown) {
